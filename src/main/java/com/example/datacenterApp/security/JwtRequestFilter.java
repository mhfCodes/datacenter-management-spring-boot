...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	public JwtRequestFilter(DatacenterUserDetailsService datacenterUserDetailsService,
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (requestTokenHeader != null && requestTokenHeader.startsWith("Bearer ")) {
			...
			try {
				...
				throw new IllegalStateException("Unabled To Get Jwt Token");
		...
		if (username != null && SecurityContextHolder.getContext().getAuthentication() ==  null) {
			...
			UserDetails userDetails = this.datacenterUserDetailsService.loadUserByUsername(username);
